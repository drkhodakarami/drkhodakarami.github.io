...
<div class="alert alert-dismissible alert-danger">
  :bulb:<strong>Remember</strong>, unlike vanilla's <strong>BlockWithEntity</strong> class, this class is not touching the <strong>getRenderType</strong> method and by default has the <strong>BlockRenderType.MODEL</strong> value and if you don't want to change it to <strong>INVISIBLE</strong> or <strong>ENTITYBLOCK_ANIMATED</strong>, you don't need to override this method.
</div>

...
> [!IMPORTANT]
> Remember, in the code snippet bellow, the `Logger` class should reference the <a name=".text-danger">jiraiyah.logger.Logger</a> and no other Logger class available.
